...
vi.mock('../services/work', () => ({ organizationService: { ensure:vi.fn(), members:vi.fn(), invitations:vi.fn(), invite:vi.fn(), updateMember:vi.fn(), removeMember:vi.fn() } }));
...
describe('Equipe', () => {
  ...
  it('Owner visualiza lista e botão de convite', async () => {
    ...
    service.members.mockResolvedValue({count:1,next:null,previous:null,results:[{id:1,user:{id:1,email:'owner@acme.test',first_name:'Ana',last_name:'Owner',avatar:null},role:'OWNER',is_active:true,joined_at:'2026-01-01'}]});
